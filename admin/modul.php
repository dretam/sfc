...
if (isset($_POST["addmodul"])) {
	...
	$tambahmodul = mysqli_query($conn, "insert into modul (judul,gambar,link) values ('$judul','$gambar','$link')");
	if ($tambahmodul) {
        echo "
		<meta http-equiv='refresh' content='1; url= modul.php'/>  ";
    } else {
        echo "
		 <meta http-equiv='refresh' content='1; url= modul.php'/> ";
    }
...
if (isset($_POST["hapus"])) {
	$kode = $_POST['idmodul'];
	$query2 = mysqli_query($conn, "delete from modul where idmodul='$kode'");
	if ($query2) {
		echo "Berhasil Hapus";
		echo "<br><meta http-equiv='refresh' content='3; URL=modul.php'> You will be redirected to the form in 3 seconds";
	} else {
		echo "Gagal Hapus";
		echo "<br><meta http-equiv='refresh' content='3; URL=modul.php'> You will be redirected to the form in 3 seconds";
	}
...
<head>
	...
	<title>Kelola Modul Pelatihan - SERCOB</title>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-sm-flex justify-content-between align-items-center">
									<h2>Daftar Modul</h2>
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2">Tambah Modul</button>
								</div>
								<div class="data-tables datatable-dark">
									<table id="dataTable3" class="display" style="width:100%">
										...
										<tbody>
											<?php
											$brgs = mysqli_query($conn, "SELECT * from modul order by idmodul ASC");
											$no = 1;
											...
											?>
												...
												<tr style="text-align: center;">
													<form method="post">
														...
														<td>
															<input type="hidden" name="idmodul" value="<?php echo $p['idmodul'] ?>" \>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="modul.php" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label>Gambar</label>
							<input name="gambar" type="text" class="form-control" value="images/modul.jpg" readonly>
						</div>
						<div class="form-group">
							<label>Link</label>
				...
				<div class="modal-footer">
					...
					<input name="addmodul" type="submit" class="btn btn-primary" value="Tambah">
				</div>
				</form>
			</div>
		</div>
