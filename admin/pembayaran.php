...
if (isset($_POST["addpay"])) {
    ...
    $path = "../img/aset/" . $random . '.' . $ext;
    $pathdb = "img/aset/" . $random . '.' . $ext;
        ...
        if ($ukuran_file <= 5000000) {
            if (move_uploaded_file($tmp_file, $path)) {
			  ...
			  values('$metode','$norek', '$pathdb', '$an')";
                ...
                if ($sql) {
                    echo "<br><meta http-equiv='refresh' content='3; URL=pembayaran.php'> You will be redirected to the form in 3 seconds";
                } else {
                    // Jika Gagal, Lakukan :
...
if (isset($_POST["hapus"])) {
    $kode = $_POST['no'];
    $query2 = mysqli_query($conn, "delete from pembayaran where no='$kode'");
    if ($query2) {
        echo "Berhasil Hapus";
        echo "<br><meta http-equiv='refresh' content='3; URL=pembayaran.php'> You will be redirected to the form in 3 seconds";
    } else {
...
<head>
    ...
    <title>Manage Payment - SFC</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $brgs = mysqli_query($conn, "SELECT * from pembayaran order by idatm ASC");
                                            $no = 1;
                                            ...
                                            ?>
                                                ...
                                                <tr style="text-align: center;">
                                                    <form method="post">
                                                        <td><?php echo $no++ ?></td>
                                                        <td><img src="../<?php echo $p['logo'] ?>" width="100px" height="100px" \></td>
                                                        <td><?php echo $p['metode'] ?></td>
                                                        <td><?php echo $p['norek'] ?></td>
                                                        <td><?php echo $p['an'] ?></td>
                                                        <td>
                                                            <input type="hidden" name="no" value="<?php echo $p['no'] ?>" \>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input name="addpay" type="submit" class="btn btn-primary" value="Tambah">
                </div>
                </form>
            </div>
        </div>
