...
if (isset($_POST["hapus"])) {
	$kode = $_POST['userid'];
	$query2 = mysqli_query($conn, "delete from login where userid='$kode' and role='Member'");
	if ($query2) {
		echo "Berhasil Hapus";
		echo "<br><meta http-equiv='refresh' content='3; URL=customer.php'> You will be redirected to the form in 3 seconds";
	} else {
		echo "Gagal Hapus";
		echo "<br><meta http-equiv='refresh' content='3; URL=customer.php'> You will be redirected to the form in 3 seconds";
	}
...
<head>
    ...
    <title>Kelola Pelanggan - SERCOB</title>
