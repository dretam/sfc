							...
							<div class="card-body">
								...
								<div class="data-tables datatable-dark">
									<table id="dataTable3" class="display" style="width:100%">
										...
										<tbody>
											<?php
											$brgs = mysqli_query($conn, "SELECT * from diskusi order by iddiskusi ASC");
											$no = 1;
													...
													<form method="post">
														...
														<td>
															<button class="btn btn-warning form-control">
                                                        		<a href="balas.php?id=<?php echo $p['iddiskusi']; ?>" style="color: white;">Balas</a>
                                                        	</button>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Berikan Balasan</h4>
				</div>
				...
				<div class="modal-body">
					<form action="diskusi.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label>Balasan</label>
                            <textarea name="isi" cols="30" class="form-control" rows="10" placeholder="Isi pertanyaan/pernyataan anda"></textarea>
						</div>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
					<input name="edit" type="submit" class="btn btn-primary" value="Balas">
				</div>
				</form>
			</div>
		</div>
