...
$iddiskusi = $_GET['id'];
$info = mysqli_query($conn, "select * from diskusi where iddiskusi='$iddiskusi'");
    ...
    <!-- main content area start -->
        <div class="main-content">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="isi" name="isi" placeholder="isi pernyataan/pertanyaan anda" value="<?php echo $p['isi']; ?>" required readonly>
            </div>
            <div class="form-group">
                <label for="exampleFormControlInput4">Balasan</label>
                <input type="text" class="form-control" id="balasan" name="balasan" placeholder="isi balasan anda" value="<?php echo $p['balasan']; ?>" required>
            </div>
